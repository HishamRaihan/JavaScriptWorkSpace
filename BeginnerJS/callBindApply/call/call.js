...
const tellMeDetailsResult = tellMeDetails2.call(person2, 30, 'humus');
...
btn.addEventListener('click', () => someTing.call(this, 'Pizza', 24));

function someTing2(a) {
	return a;
}
function printFunc() {
	console.log(someTing2.call(this, 'blueberry'));
}
